...
| canonical-exact-provenance | Record supporting provenance during canonical exact auto-resolution. | implemented | top-level session | top-level session |  | `004_CANONICAL_EXACT_PROVENANCE_PLAN.md` |
