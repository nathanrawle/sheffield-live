...
| --- | --- | --- | --- | --- | --- | --- |
| import-supporting-source | Add existing-event supporting-source attachment and manual new-listing secondary-source persistence for import-review clusters. | reviewed | top-level session | top-level session | 019e6180-3a23-7083-b03d-4c057ce6638d | `001_IMPORT_SUPPORTING_SOURCE_PLAN.md` |
| import-near-title-resolution | Add near-title same-event and false-positive separation/new-listing paths. | reviewed | top-level session | top-level session | 019e6180-3a23-7083-b03d-4c057ce6638d | `002_IMPORT_NEAR_TITLE_RESOLUTION_PLAN.md` |
| import-authoritative-resolution | Add manual authoritative import resolution with source-first target semantics. | reviewed | top-level session | top-level session | 019e6180-3a23-7083-b03d-4c057ce6638d | `003_IMPORT_AUTHORITATIVE_RESOLUTION_PLAN.md` |
